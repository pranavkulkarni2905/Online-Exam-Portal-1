...
<head>
    ...
    <title>Demo Quiz | ThinkExam</title>
...
<body>
    <!-- start Quiz button -->
    <div class="start_btn"><button>Start Demo</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="Index.jsp"><button>Back To Home</button></a></div>
    ...
    <div class="quiz_box">
        <header>
            <div class="title">ThinkExam Demo Exam</div>
            <div class="timer">
